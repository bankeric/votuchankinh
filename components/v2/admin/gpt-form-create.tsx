...
interface GPTFormCreateProps {
}

export function GPTFormCreate({ }: GPTFormCreateProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <Label className="text-base font-medium">
          {t("gptEditor.form.conversationStarters")}
        </Label>
