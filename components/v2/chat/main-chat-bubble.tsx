...
export function MainChatBubble({
  ...
  const handleThumbsDown = async () => {
    ...
    try {
      ...
      const dislikedMessage = await messagesService.dislikeMessage(message.uuid)
      // update message state
      updateMessage(activeChatId, message.uuid, {
    ...
    <>
      ...
      >
        ...
        >
          <Card
            className={cn(
              'p-5 shadow-sm border-2 border-black rounded-2xl relative bg-[#f3ead7] text-[#1F1F1F]',
              message.role === MessageRole.USER
                ? '  ml-12'
                : ' backdrop-blur-sm mr-12'
            )}
          >
            {/* Title Card */}
            ...
            <div className='prose prose-sm max-w-none'>
              ...
              {isLastMessage && isLoading && (
                <div className='flex space-x-1 mt-3'>
                  <div className='h-2 w-2 bg-[#1F1F1F] rounded-full animate-pulse' />
                  <div className='h-2 w-2 bg-[#1F1F1F] rounded-full animate-pulse delay-150' />
                  <div className='h-2 w-2 bg-[#1F1F1F] rounded-full animate-pulse delay-300' />
                </div>
              )}
              ...
              {message.role === MessageRole.ASSISTANT && (
                <Image
                  ...
                  width={40}
                  height={40}
                  className='w-8 h-8 md:w-12 md:h-12 rounded-full object-cover absolute top-0 left-[-60px]'
                />
              )}
              ...
              {/* Assistant actions */}
              {message.role === MessageRole.ASSISTANT && !isLoading && (
                <div className='flex w-full items-center justify-between border-t border-black pt-2'>
                  <div className='flex items-center gap-1'>
                    <Button
                      ...
                      className={cn(
                        ...
                        isMessageLiked && ' text-green-600 hover:text-green-700'
                      )}
                    >
                    ...
                    <Button
                      ...
                      className={cn(
                        'h-6 w-6 p-0  text-black rounded-full hover:bg-black/5',
                        isMessageDisliked && ' text-red-600 hover:text-red-700'
                      )}
                    >
        ...
        <DialogContent className='sm:max-w-[500px]'>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className='bg-black hover:bg-orange-700 text-white'
            >
