...
export default function CountdownTimer({ initialMinutes = 0, initialSeconds = 0, onComplete }: CountdownTimerProps) {
  ...
  return (
    <div className="flex items-center justify-center font-twk-everett">
      <div className="flex items-center">
        ...
        <div className="text-gray-800 text-7xl mx-1 font-twk-everett font-normal">:</div>
        <div className="-mx-2">
