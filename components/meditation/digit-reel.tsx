...
export default function DigitReel({ value, className }: DigitReelProps) {
  ...
  return (
    <div className={cn("relative w-20 h-28 overflow-hidden font-twk-everett", className)}>
      ...
      <div className="absolute top-0 left-0 right-0 h-12 z-10 bg-gradient-to-b from-[#d4c4a0] to-transparent pointer-events-none"></div>
              ...
              {reelDigits.map((digit, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    index === 2 ? "text-gray-800" : "text-gray-500",
                    index < 2 ? "-mb-4" : "",
                    index > 2 ? "-mt-4" : "",
                  )}
                >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-12 z-10 bg-gradient-to-t from-[#d4c4a0] to-transparent pointer-events-none"></div>
    </div>
  )
}
