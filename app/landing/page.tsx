...
function StatCard({ stat, isVisible }: { stat: Stat; isVisible: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="text-sm md:text-base font-serif text-[#eae6dd]/70 mb-2 text-center">{stat.title}</h3>

      {/* Description */}
      <p className="text-xs text-[#eae6dd]/40 text-center max-w-[200px] font-light">{stat.description}</p>
        ...
        setStats([
          {
            ...
            value: data.newRegistrations || 127,
          ...
          },
          {
            ...
            value: data.activeUsers || 430,
            description: "Giá trị thực mang lại",
            tooltip: "Số người dùng hoạt động hàng ngày (DAU) và hàng tháng (MAU)",
            icon: <Users size={32} />,
            suffix: " DAU",
          },
          {
            title: "Nâng cấp gói",
            value: data.upgrades || 23,
        ...
        setStats([
          {
            ...
            description: "Thước đo thu hút người dùng",
            tooltip: "Số tài khoản mới được tạo trong 30 ngày gần nhất",
            icon: (<Image src="/images/landing-1.png" alt="Giac Ngo logo" width={80} height={80} />),
          },
          {
            title: "Người dùng hoạt động",
            value: 430,
            description: "Giá trị thực mang lại",
            tooltip: "Số người dùng hoạt động hàng ngày (DAU) và hàng tháng (MAU)",
            icon: (<Image src="/images/landing-2.png" alt="Giac Ngo logo" width={80} height={80} />),
            suffix: " DAU",
          },
          {
            title: "Nâng cấp gói",
            ...
            description: "Sẵn sàng trả phí",
            tooltip: "Số lượt nâng cấp từ Basic lên Pro/Premium trong tháng",
            icon: (<Image src="/images/pricing-1.png" alt="Giac Ngo logo" width={80} height={80} />),
          ...
          },
          {
            ...
            description: "Lan tỏa thông điệp",
            tooltip: "Tổng số lần chia sẻ nội dung ra mạng xã hội",
            icon: (<Image src="/images/pricing-3.png" alt="Giac Ngo logo" width={80} height={80} />),
  ...
  return (
    <>
      <style jsx>{`
        ...
        .stagger-2 { animation-delay: 1.3s; }
        .stagger-3 { animation-delay: 2.1s; }
        .stagger-4 { animation-delay: 2.9s; }
        .stagger-5 { animation-delay: 3.7s; }
      `}</style>

      <main className="flex flex-col items-center justify-start min-h-screen bg-black/30">
        <div className="flex items-center justify-center min-h-screen w-full cursor-pointer" onClick={handleClick}>
          <div
          ...
          >
            <div className="flex flex-col items-center">
              <div className={`mb-2 opacity-0 ${isVisible ? "animate-fade-in-up stagger-1" : ""}`}>
                <Image
                  src="/images/logo.png"
                  alt="Giac Ngo logo"
                  width={120}
              ...
              <h1
                ...
                style={{
                  ...
                  background: "linear-gradient(45deg, #eae6dd 0%, #d4af37 30%, #eae6dd 60%, #c9a96e 100%)",
            ...
            >
              <span key={characters[index]} className="animate-character">
                {characters[index]}
              </span>
            </div>
            <p
        ...
        <div ref={statsRef} className="w-full max-w-6xl px-4 py-16 md:py-24">
